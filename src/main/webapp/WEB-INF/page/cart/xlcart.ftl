...
<form class="layui-form">
    ...
    <table id="XlCartList" lay-filter="XlCartList"></table>

    <!--操作-->
    <script type="text/html" id="XlCartListBar">
        <a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
        <a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="del">删除</a>
    </script>
</form>
<script type="text/javascript" src="/resource/plugin/layui/layui.js"></script>
<script type="text/javascript" src="/resource/js/cart/xlcart.js"></script>